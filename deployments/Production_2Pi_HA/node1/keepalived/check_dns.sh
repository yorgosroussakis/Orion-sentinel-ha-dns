...
# 2-Pi DNS HA Architecture - PRIMARY Node
# =============================================================================
#
...
readonly LOG_TAG="keepalived-check-primary"

# Node-specific configuration
readonly NODE_ROLE="primary"
readonly PIHOLE_CONTAINER="pihole_primary"
readonly UNBOUND_CONTAINER="unbound_primary"
